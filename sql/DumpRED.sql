...
INSERT INTO `redalert` VALUES (1,'tel:94771122336','Fire',6.9167,79.8333,'2015-12-11 06:16:29'),(2,'tel:94771122336','Fire',6.9167,79.8333,'2015-12-11 06:16:29'),(3,'tel:94771122336','Fire',6.9167,79.8333,'2015-12-11 06:16:29');
/*!40000 ALTER TABLE `redalert` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `redfire_div`
--

DROP TABLE IF EXISTS `redfire_div`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `redfire_div` (
  `idfd` int(11) NOT NULL AUTO_INCREMENT,
  `div_id` varchar(20) DEFAULT NULL,
  `tel_no` varchar(245) DEFAULT NULL,
  `type` varchar(10) DEFAULT NULL,
  `latitude` double DEFAULT NULL,
  `longitude` double DEFAULT NULL,
  `alt_time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`idfd`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `redfire_div`
--

LOCK TABLES `redfire_div` WRITE;
/*!40000 ALTER TABLE `redfire_div` DISABLE KEYS */;
INSERT INTO `redfire_div` VALUES (1,'div123','tel:94771122336','fire',6.9167,79.8333,'2015-12-11 06:42:40');
/*!40000 ALTER TABLE `redfire_div` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `redsessions` VALUES ('123','tel:94771122336','main','0','2015-12-11 06:16:29','',79.8333,6.9167),('12385456','tel:94771122336','sub','0','2015-12-11 17:37:29','',79.8333,6.9167);
...
-- Dump completed on 2015-12-12  5:38:54
